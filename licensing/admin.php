...
<tr><td>
<span class="headerText"><?php echo _("Users");?></span>&nbsp;&nbsp;<span id='span_User_response' class='redText'></span><span id='span_newUser' class='adminAddInput'><?php echo "<a href='#' onclick='javascript:myDialog(\"ajax_forms.php?action=getAdminUserUpdateForm\",225,350)' class='thickbox' id='expression'><img id='addUser class='AdminAddIcon' src='images/plus.gif' title='"._("add User")."' /></a>";?></span>
...
<table class="headerTable">
<tr><td>
<span class="headerText"><?php echo _("Qualifiers");?></span>&nbsp;&nbsp;<span id='span_Qualifier_response'></span><span id='span_newQualifier' class='adminAddInput'><a href='#' onclick='javascript:myDialog("ajax_forms.php?action=getQualifierForm",225,350)' class='thickbox'><?php echo "<img id='addQualifier' src='images/plus.gif' title='"._("add qualifier")."' />";?></a></span>
...
if ($config->settings->useTermsToolFunctionality == 'Y') { ?>
    ...
    <table class="headerTable">
        <tr><td>
                ...
                <br /><a href="#" onclick='javascript:myDialog("ajax_forms.php?action=getTermsToolSettingsForm&",225,350)' class="thickbox"><?php echo _("edit"); ?></a>
                <br />
                <br />
